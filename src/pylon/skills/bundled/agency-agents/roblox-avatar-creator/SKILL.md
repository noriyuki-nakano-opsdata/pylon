---
id: agency-agents:roblox-avatar-creator
alias: roblox-avatar-creator
skill_key: roblox-avatar-creator
...
context_contracts:
- contract_id: roblox-avatar-creator:fbx
  skill_id: roblox-avatar-creator
  path_patterns:
  - .fbx
  mode: read
  required: false
  description: Compatibility-inferred context contract for .fbx.
  discovery_hint: Check whether .fbx exists before running the skill.
  max_chars: 4000
- contract_id: roblox-avatar-creator:obj
  skill_id: roblox-avatar-creator
  path_patterns:
  - .obj
  mode: read
  required: false
  description: Compatibility-inferred context contract for .obj.
  discovery_hint: Check whether .obj exists before running the skill.
  max_chars: 4000
- contract_id: roblox-avatar-creator:png
  skill_id: roblox-avatar-creator
  path_patterns:
  - .png
  mode: read
  required: false
  description: Compatibility-inferred context contract for .png.
  discovery_hint: Check whether .png exists before running the skill.
  max_chars: 4000
