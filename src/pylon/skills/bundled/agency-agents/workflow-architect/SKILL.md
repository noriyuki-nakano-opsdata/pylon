---
id: agency-agents:workflow-architect
alias: workflow-architect
skill_key: workflow-architect
...
description: Workflow design specialist who maps complete workflow trees for every
  ...
  build-ready specs that agents can implement against and QA can test against.
