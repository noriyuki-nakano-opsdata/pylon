---
id: agency-agents:godot-shader-developer
alias: godot-shader-developer
skill_key: godot-shader-developer
...
context_contracts:
- contract_id: godot-shader-developer:res
  skill_id: godot-shader-developer
  path_patterns:
  - .res
  mode: read
  required: false
  description: Compatibility-inferred context contract for .res.
  discovery_hint: Check whether .res exists before running the skill.
  max_chars: 4000
