---
id: agency-agents:unity-shader-graph-artist
alias: unity-shader-graph-artist
skill_key: unity-shader-graph-artist
...
context_contracts:
- contract_id: unity-shader-graph-artist:hlsl
  skill_id: unity-shader-graph-artist
  path_patterns:
  - .hlsl
  mode: read
  required: false
  description: Compatibility-inferred context contract for .hlsl.
  discovery_hint: Check whether .hlsl exists before running the skill.
  max_chars: 4000
- contract_id: unity-shader-graph-artist:shader
  skill_id: unity-shader-graph-artist
  path_patterns:
  - .shader
  mode: read
  required: false
  description: Compatibility-inferred context contract for .shader.
  discovery_hint: Check whether .shader exists before running the skill.
  max_chars: 4000
