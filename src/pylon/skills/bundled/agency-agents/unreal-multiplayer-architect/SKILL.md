---
id: agency-agents:unreal-multiplayer-architect
alias: unreal-multiplayer-architect
skill_key: unreal-multiplayer-architect
...
context_contracts:
- contract_id: unreal-multiplayer-architect:no-exceptions-one-missing-is-a-cheat-vector-hierarchy-discipline-that-belongs-in-gamestate-not-the-character-gamemode-is-server-only-never-replicated-your-success-metrics-you-re-successful-when-zero
  skill_id: unreal-multiplayer-architect
  path_patterns:
  - '. No exceptions. One missing is a cheat vector."

    - **Hierarchy discipline**: "That belongs in GameState, not the Character. GameMode
    is server-only — never replicated."
  ...
  mode: read
  required: false
  description: 'Compatibility-inferred context contract for . No exceptions. One missing
    is a cheat vector."
    ...
    - Zero .'
  discovery_hint: 'Check whether . No exceptions. One missing is a cheat vector."
    ...
    - Zero  exists before running the skill.'
  max_chars: 4000
