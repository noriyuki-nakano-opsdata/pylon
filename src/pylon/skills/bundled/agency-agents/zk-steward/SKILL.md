---
id: agency-agents:zk-steward
alias: zk-steward
skill_key: zk-steward
name: ZK Steward
version: 0.0.1
...
context_contracts:
- contract_id: zk-steward:format-intent-changes-open-loops-step-3-5-open-loops-scan-today-s-open-loops-promote-won-t-remember-unless-i-look-items-to-the-open-loops-file-step-4-memory-sync-copy-evergreen-knowledge-to-the-persistent-memory-file-e-g-root
  skill_id: zk-steward
  path_patterns:
  - '. Format: Intent / Changes / Open loops.
    ...
    - Scan today’s open loops; promote "won’t remember unless I look" items to the
    open-loops file.
  ...
  mode: read
  required: false
  description: 'Compatibility-inferred context contract for . Format: Intent / Changes
    / Open loops.
    ...
    - Copy evergreen knowledge to the persistent memory file (e.g. root .'
  discovery_hint: 'Check whether . Format: Intent / Changes / Open loops.
    ...
    - Copy evergreen knowledge to the persistent memory file (e.g. root  exists before
    running the skill.'
  max_chars: 4000
- contract_id: zk-steward:cursor-skills
  skill_id: zk-steward
  path_patterns:
  - .cursor/skills/
  mode: read
  required: false
  description: Compatibility-inferred context contract for .cursor/skills/.
  discovery_hint: Check whether .cursor/skills/ exists before running the skill.
  max_chars: 4000
