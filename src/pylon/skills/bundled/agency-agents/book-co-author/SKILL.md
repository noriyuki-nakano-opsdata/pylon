---
id: agency-agents:book-co-author
alias: book-co-author
skill_key: book-co-author
name: Book Co-Author
version: 0.0.1
...
context_contracts:
- contract_id: book-co-author:editorial-gaps-must-be-visible-missing-proof-uncertain-chronology-or-weak-logic-should-be-called-out-directly-in-notes-not-hidden-inside-polished-prose-your-technical-deliverables-chapter-blueprint
  skill_id: book-co-author
  path_patterns:
  - '.


    **Editorial Gaps Must Be Visible**: Missing proof, uncertain chronology, or weak
    logic should be called out directly in notes, not hidden inside polished prose.
  ...
  description: 'Compatibility-inferred context contract for .
    ...
    **Chapter Blueprint**
    ...
    .'
  discovery_hint: "Check whether .\n\n**Editorial Gaps Must Be Visible**: Missing\
    \ proof, uncertain chronology, or weak logic should be called out directly in\
    \ notes, not hidden inside polished prose.\n\n## Your Technical Deliverables\n\
