---
id: agency-agents:unity-editor-tool-developer
alias: unity-editor-tool-developer
skill_key: unity-editor-tool-developer
...
context_contracts:
- contract_id: unity-editor-tool-developer:asmdef
  skill_id: unity-editor-tool-developer
  path_patterns:
  - .asmdef
  mode: read
  required: false
  description: Compatibility-inferred context contract for .asmdef.
  discovery_hint: Check whether .asmdef exists before running the skill.
  max_chars: 4000
