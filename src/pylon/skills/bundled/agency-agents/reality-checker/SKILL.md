---
id: agency-agents:reality-checker
alias: reality-checker
skill_key: reality-checker
...
reference_assets:
- skill_id: reality-checker
  path: strategy/playbooks/phase-4-hardening.md
  kind: reference-md
  title: 🛡️ Phase 4 Playbook — Quality & Hardening
  tags: []
  digest: 0db1b7dc62dccc30579f06e8f2b480f7b04fcd153fca7df43aa2470f46907386
- skill_id: reality-checker
...
- strategy/coordination/handoff-templates.md
context_contracts:
- contract_id: reality-checker:qa-screenshot-results
  skill_id: reality-checker
  path_patterns:
  ...
  discovery_hint: Load the QA capture summary before issuing a pass/fail verdict.
  max_chars: 6000
