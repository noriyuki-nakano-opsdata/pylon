---
id: agency-agents:carousel-growth-engine
alias: carousel-growth-engine
skill_key: carousel-growth-engine
...
reference_assets:
- skill_id: carousel-growth-engine
...
context_contracts:
- contract_id: carousel-growth-engine:returns
  skill_id: carousel-growth-engine
  path_patterns:
  - '. Returns '
  mode: read
  required: false
  description: Compatibility-inferred context contract for . Returns .
  discovery_hint: Check whether . Returns  exists before running the skill.
  max_chars: 4000
