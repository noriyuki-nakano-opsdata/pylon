---
id: agency-agents:unreal-systems-engineer
alias: unreal-systems-engineer
skill_key: unreal-systems-engineer
...
context_contracts:
- contract_id: unreal-systems-engineer:build-cs
  skill_id: unreal-systems-engineer
  path_patterns:
  - .Build.cs
  mode: read
  required: false
  description: Compatibility-inferred context contract for .Build.cs.
  discovery_hint: Check whether .Build.cs exists before running the skill.
  max_chars: 4000
- contract_id: unreal-systems-engineer:uproject
  skill_id: unreal-systems-engineer
  path_patterns:
  - .uproject
  mode: read
  required: false
  description: Compatibility-inferred context contract for .uproject.
  discovery_hint: Check whether .uproject exists before running the skill.
  max_chars: 4000
