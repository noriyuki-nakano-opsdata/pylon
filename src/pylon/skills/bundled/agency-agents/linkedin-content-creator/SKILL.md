---
id: agency-agents:linkedin-content-creator
alias: linkedin-content-creator
skill_key: linkedin-content-creator
...
reference_assets:
- skill_id: linkedin-content-creator
...
context_contracts:
- contract_id: linkedin-content-creator:context
  skill_id: linkedin-content-creator
  path_patterns:
  - '. '
  mode: read
  required: false
  description: Compatibility-inferred context contract for . .
  discovery_hint: Check whether .  exists before running the skill.
  max_chars: 4000
- contract_id: linkedin-content-creator:never-more-than-5-tag-sparingly-only-tag-people-when-genuinely-relevant-tag-spam-kills-reach-and-damages-real-relationships-your-technical-deliverables-post-drafts-with-hook-variants-every-post-draft-includes-3-hook-options
  skill_id: linkedin-content-creator
  path_patterns:
  - '. Never more than 5.


    **Tag Sparingly**: Only tag people when genuinely relevant. Tag spam kills reach
    and damages real relationships.
  ...
  mode: read
  required: false
  description: 'Compatibility-inferred context contract for . Never more than 5.
    ...
    **Post Drafts with Hook Variants**
    ...
    .'
  discovery_hint: "Check whether . Never more than 5.\n\n**Tag Sparingly**: Only tag\
    \ people when genuinely relevant. Tag spam kills reach and damages real relationships.\n\
    \n## \U0001F4CB Your Technical Deliverables\n\n**Post Drafts with Hook Variants**\n\
